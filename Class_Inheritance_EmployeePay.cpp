...
{ 
 ...
 void Employee::GetInfo(){
      ...
      while (departnum<=0);
       ...
       void SalariedEmployee::GetYearlySalary(){
 ...
 void SalariedEmployee::PayFrequency(){
           ...
           while(!(cin>>payfreq)){
                cin.clear();
                cin.ignore(10000,'\n');
                cout<<"\nPlease enter an integer for the pay frequency: "<<flush;
                cout<<"\a";                       
           }
                      
           if (payfreq>0)
           cout<< "\nThis salaried employee gets paid every: "<< payfreq << " week(s).\n";               
 ...
 void SalariedEmployee::PayPeriodPay(){
...
void HourlyEmployee::AnnuallyPay(){
            ...
            while(!(cin>> myHourlyWage)){
                cin.clear();
                cin.ignore(10000,'\n');
                cout<<"\nPlease enter an float for myHourlyWage: "<<flush;
                cout<<"\a";                       
           } 
